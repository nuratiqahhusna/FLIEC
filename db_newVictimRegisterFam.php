...
// Debugging output for session variables
error_log("pps id: " . $_SESSION['pps_id']);
error_log("datePps: " . $_SESSION['datePps']);
error_log("victimFamilyStatus: " . $_SESSION['victimFamilyStatus']);
error_log("victimAddress: " . $_SESSION['victimAddress']);
error_log("familyId: " . $_SESSION['family_id']);
